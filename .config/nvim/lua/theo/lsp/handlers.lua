...
local lspactions_ok, lspactions = pcall(require, "lspactions")
if lspactions_ok then
...
local function lsp_keymaps(bufnr)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>c", "<cmd>lua vim.lsp.buf.format()<CR>", opts)
end
